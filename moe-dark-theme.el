...
(let ((class '((class color) (min-colors 89)))
      ...
      (green-1 "#88ff33") (green-2 "#75db2c") (green-3 "#5bae23") (green-4 "#48871b") (green-5 "#005f00")

      ;;(cyan-1 "#87ffff") (cyan-2 "#87d7af") (cyan-3 "#00d7af") (cyan-4 "#00ac8a") (cyan-5 "#5faf87") (cyan-6 "#005f5f") (cyan-7 "#236f73")
      (cyan-1 "#87ffff") (cyan-2 "#87d7af") (cyan-3 "#00d7af") (cyan-4 "#12a182") (cyan-5 "#5faf87") (cyan-6 "#005f5f") (cyan-7 "#236f73")
      ...
      (black-2-5 "#675c6c") (black-3 "#4b434e") (black-4 "#37323a") (black-5 "#2e2930") (black-6 "#000000")
      ...
      (comment-green "#a4aca7")
      )
  ;; Customize color
  (defconst -moe-dark-bg                         black-5)
  (defconst -moe-dark-fg                         white-0)
  (defconst -moe-dark-builtin                    purple-1)
  (defconst -moe-dark-comment-delimiter          comment-green)
  (defconst -moe-dark-comment                    comment-green)
  ...
  (custom-theme-set-faces
   ...
   `(org-todo ((,class (:bold t :weight bold :foreground ,red-3 :background ,orange-0
                              :box (:line-width 1 :style none)))))
   `(org-level-1 ((,class (:weight bold :foreground ,yellow-2))))
   `(org-level-2 ((,class (:weight bold :foreground ,green-2))))
   `(org-level-3 ((,class (:weight bold :foreground ,orange-2))))
   `(org-level-4 ((,class (:weight bold :foreground ,cyan-3))))
   `(org-level-5 ((,class (:weight bold :foreground ,red-0))))
   `(org-level-6 ((,class (:weight bold :foreground ,purple-2))))
   `(org-level-7 ((,class (:weight bold :foreground ,magenta-2))))
   `(org-level-8 ((,class (:weight bold :foreground ,blue-1))))
   ...
   `(flyspell-incorrect ((,class (:underline (:color ,red-0 :style wave)))))
