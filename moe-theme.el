...
(defun moe-light ()
  ...
  (cond ((eq moe-theme-mode-line-color 'blue)
         ...
         (set-face-attribute 'mode-line-buffer-id nil :foreground "#080808")
        ...
        ((eq moe-theme-mode-line-color 'green)
         ...
         (set-face-attribute 'mode-line-buffer-id nil :foreground "#3a3a3a")
        ...
        ((eq moe-theme-mode-line-color 'orange)
         ...
         (set-face-attribute 'mode-line-buffer-id nil :foreground "#1c1c1c")
